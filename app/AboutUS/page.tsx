const AboutUS = () => {
    ...
    <div className="flex flex-wrap lg:w-4/5 sm:mx-auto sm:mb-2 -mx-2">
      <div className="p-2 sm:w-1/2 w-full">
        <div className="bg-gray-800 rounded flex p-4 h-full items-center">
          ...
          <span className="title-font font-medium text-white">Explore Hackathons like never before</span>
        </div>
      </div>
      <div className="p-2 sm:w-1/2 w-full">
        <div className="bg-gray-800 rounded flex p-4 h-full items-center">
          ...
          <span className="title-font font-medium text-white">Community Engangement</span>
        </div>
      </div>
      <div className="p-2 sm:w-1/2 w-full">
        <div className="bg-gray-800 rounded flex p-4 h-full items-center">
          ...
          <span className="title-font font-medium text-white">Connect with you team mate according to tech stack</span>
        </div>
      </div>
      <div className="p-2 sm:w-1/2 w-full">
        <div className="bg-gray-800 rounded flex p-4 h-full items-center">
          ...
          <span className="title-font font-medium text-white">Discussion Forums for every individual</span>
        </div>
      </div>
      <div className="p-2 sm:w-1/2 w-full">
        <div className="bg-gray-800 rounded flex p-4 h-full items-center">
          ...
          <span className="title-font font-medium text-white">Chat with Mentor for any problem directly</span>
        </div>
      </div>
      <div className="p-2 sm:w-1/2 w-full">
        <div className="bg-gray-800 rounded flex p-4 h-full items-center">
          ...
          <span className="title-font font-medium text-white">Know which Hackathon is for you with our recommendation system</span>
        </div>
      </div>
    </div>
  ...
  <div className="flex flex-col text-center w-full mb-20">
    <h1 className="sm:text-3xl text-2xl font-medium title-font mb-0 text-white">Our Data says it all !</h1>
  ...
  <div className="flex flex-wrap -m-4 text-center">
    <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
      <div className="border-2 border-gray-800 px-4 py-6 rounded-lg">
        ...
        <p className="leading-relaxed">Team mates found</p>
      </div>
    </div>
    <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
      <div className="border-2 border-gray-800 px-4 py-6 rounded-lg">
    ...
    <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
      <div className="border-2 border-gray-800 px-4 py-6 rounded-lg">
        ...
        <p className="leading-relaxed">Mentor Sessions</p>
      </div>
    </div>
    <div className="p-4 md:w-1/4 sm:w-1/2 w-full">
      <div className="border-2 border-gray-800 px-4 py-6 rounded-lg">
    ...
    <button className="flex mx-auto mt-16 text-black bg-white border-0 py-2 px-8 focus:outline-none hover:bg-gray-600 rounded text-lg">Join Now</button>
  </div>
</section>
</div>
