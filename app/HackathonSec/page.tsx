          ...
          <div className="flex flex-wrap -m-4">
            <div className="xl:w-1/4 md:w-1/2 p-4">
              <div className="bg-gray-100 p-6 rounded-lg">
                ...
                Get ready to embark on an epic journey of innovation and creativity at Wittyhacks 4.0, the ultimate 36-hour hackathon experience! Hosted in Indore.</p>
              </div>
            </div>
            <div className="xl:w-1/4 md:w-1/2 p-4">
              <div className="bg-gray-100 p-6 rounded-lg">
                ...
                Join us for the reinvigorated Hack4Bengal.
                </p>
              </div>
            </div>
            <div className="xl:w-1/4 md:w-1/2 p-4">
              <div className="bg-gray-100 p-6 rounded-lg">
                ...
                <p className="leading-relaxed text-base">
                ​Hack This Fall is one of the most welcoming, inclusive, and thriving hacker communities in India. It was started in 
                2020 with a mindset.
                </p>
              </div>
            </div>
            <div className="xl:w-1/4 md:w-1/2 p-4">
              <div className="bg-gray-100 p-6 rounded-lg">
                ...
                <p className="leading-relaxed text-base">
                HackHive, a PAN-India 36-hour multi-domain hackathon.
                HackHive brings together tech hunters to collaboratively build together and create an impact.
                </p>
              </div>
            </div>
            <div className="xl:w-1/4 md:w-1/2 p-4">
