...
const HackathonSec = async () => {
  let { data: Hackathon_db, error } = await supabase
    .from("Hackathon_db")
    .select("*");
  // console.log(Hackathon_db);
  return (
    <section className="text-gray-600 body-font">
      <div className="container px-5 py-24 mx-auto">
        <div className="flex flex-wrap w-full mb-20">
          <div className="lg:w-1/2 w-full mb-6 lg:mb-0">
            <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 dark:text-white">
              Explore Hackathons
            </h1>
            <div className="h-1 w-20 bg-blue-500 rounded"></div>
          </div>
          <p className="lg:w-1/2 w-full leading-relaxed dark:text-gray-200">
        ...
        <div className="flex flex-wrap -m-4">
          ...
          <div className="xl:w-1/4 md:w-1/2 p-4">
            <div className="bg-gray-100 p-6 rounded-lg">
              ...
              <p className="leading-relaxed text-base">
                ...
                technology and opportunities to generate practical solutions for
                real-world problems.
              </p>
            </div>
          </div>
          <div className="xl:w-1/4 md:w-1/2 p-4">
            <div className="bg-gray-100 p-6 rounded-lg">
              ...
              <p className="leading-relaxed text-base">
                HackBytes is a 1.5 day, free, beginner friendly web development
                international hackathon! It is for participants 13+.
              </p>
            </div>
          </div>
          <div className="xl:w-1/4 md:w-1/2 p-4">
            <div className="bg-gray-100 p-6 rounded-lg">
              ...
              <p className="leading-relaxed text-base">
                ...
                (web 3) in Mumbai that will be happening for 40 hours that is 3
                days .
              </p>
            </div>
          </div>
          <div className="xl:w-1/4 md:w-1/2 p-4">
            <div className="bg-gray-100 p-6 rounded-lg">
              ...
              <p className="leading-relaxed text-base">
                TecHacks, a student-run hackathon community, was founded by the
                students of Chitkara University, Punjab in 2019.
              </p>
            </div>
          </div>
        </div>
